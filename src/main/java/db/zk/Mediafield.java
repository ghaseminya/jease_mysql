...
public class Mediafield extends Vbox {
    ...
    public Mediafield() {
        ...
        rotateImage.addEventListener(
                ...
                $event -> {
                    try {
                        ...
                        File rotatedImage = db.util.Images.rotate(imageFile);
        ...
        EventListener<Event> dimensionChanged = $event -> {
            ...
            if (aspectRatioLock.isChecked()) {
                scaledDimension = db.util.Images.scaleDimension(
            ...
            File imageFile = Medias.asFile(media);
            imageFile.deleteOnExit();
            File scaledImage = db.util.Images.scale(imageFile,
                    scaledDimension);
    ...
    private void adjustImage() {
        try {
            ...
            File imageFile = Medias.asFile(media);
            imageFile.deleteOnExit();
            originalDimension = db.util.Images.getSize(imageFile);
